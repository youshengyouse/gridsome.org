<template>
  <Section dots="true" class="post"  dark="true">
      ...
      <Card class="text-center container-mini mb">
        ...
        <p> <g-link to="/docs/deploy-to-netlify/">Netlify</g-link>, <g-link to="/docs/deploy-to-amplify/">AWS Amplify</g-link>, <g-link to="/docs/deploy-to-vercel/">Vercel (formerly ZEIT Now)</g-link>, <g-link to="/docs/deploy-to-amazon-s3/">Amazon S3</g-link>, Surge.sh, Aerobatic, Now.sh & many more.</p>
      </Card>
